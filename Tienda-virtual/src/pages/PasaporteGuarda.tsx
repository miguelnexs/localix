...
const PasaporteGuarda = () => {
  const navigate = useNavigate();
  
  const products = [
    { id: 26, name: "Travel Pro", price: "€25", image: "https://images.unsplash.com/photo-1553062407-98eeb64c6a62?w=400&h=400&fit=crop" },
    { id: 27, name: "Secure", price: "€30", image: "https://images.unsplash.com/photo-1584917865442-de89df76afd3?w=400&h=400&fit=crop" },
    { id: 28, name: "Premium", price: "€40", image: "https://images.unsplash.com/photo-1594223274512-ad4803739b7c?w=400&h=400&fit=crop" },
  ];
      ...
      <div className="container mx-auto px-6 py-16">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-neutral-600 mt-4">
            Protección elegante para tus documentos
          </p>
        </div>
...
export default PasaporteGuarda;
